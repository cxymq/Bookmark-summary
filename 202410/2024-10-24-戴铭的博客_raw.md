...
### [](https://ming1016.github.io/2024/09/05/iOS-performance-optimization-second-time/#%E7%BA%BF%E7%A8%8B%E6%AD%BB%E9%94%81 "线程死锁")线程死锁
...
### [](https://ming1016.github.io/2024/09/05/iOS-performance-optimization-second-time/#Metrics "Metrics")Metrics
...
### [](https://ming1016.github.io/2024/09/05/iOS-performance-optimization-second-time/#%E4%BB%A3%E7%A0%81%E4%BC%98%E5%8C%96 "代码优化")代码优化
...
通过对元类（meta-class）的结构体进行深入分析，我们可以找到class\_rw\_t这样一个结构体，它是元类内部结构的一部分。在class\_rw\_t中，存在一个flag标志位，这个标志位用于记录类的各种状态信息。
...
也就是通过isa指针找到元类，再分析元类中的class\_rw\_t结构体中的flag标志位，我们可以得知OC中某个类是否已被初始化。
...
### [](https://ming1016.github.io/2024/09/05/iOS-performance-optimization-second-time/#%E7%BC%96%E8%AF%91%E5%99%A8%E4%BC%98%E5%8C%96 "编译器优化")编译器优化
...
还可以使用 -why\_load 链接器标志来减少 iOS 应用程序的二进制文件大小， -why\_load 标志的作用：它可以帮助开发者识别最终二进制文件中包含的不必要符号。
...
\-ObjC 标志，它通常用于强制链接所有 Objective-C 代码到最终的二进制文件中。这在某些情况下是必要的，例如使用了某些需要反射的 Objective-C 代码时，但是它也会导致未使用的代码被包含进去。通过 -why\_load，开发者可以识别出哪些代码是多余的，并通过删除 -ObjC 标志来减少文件大小。

[](https://ming1016.github.io/2024/09/05/iOS-performance-optimization-second-time/#%E6%80%A7%E8%83%BD%E5%88%86%E6%9E%90 "性能分析")性能分析
-----------------------------------------------------------------------------------------------------------------------------------
...
[](https://ming1016.github.io/2024/09/05/iOS-performance-optimization-second-time/#Bazel "Bazel")Bazel
------------------------------------------------------------------------------------------------------

### [](https://ming1016.github.io/2024/09/05/iOS-performance-optimization-second-time/#%E4%BB%8B%E7%BB%8D-1 "介绍")介绍
...
### [](https://ming1016.github.io/2024/09/05/iOS-performance-optimization-second-time/#WORKSPACE-%E6%96%87%E4%BB%B6 "WORKSPACE 文件")WORKSPACE 文件
...
### [](https://ming1016.github.io/2024/09/05/iOS-performance-optimization-second-time/#BUILD-%E6%96%87%E4%BB%B6 "BUILD 文件")BUILD 文件
...
### [](https://ming1016.github.io/2024/09/05/iOS-performance-optimization-second-time/#Starlark-%E8%AF%AD%E8%A8%80 "Starlark 语言")Starlark 语言
...
### [](https://ming1016.github.io/2024/09/05/iOS-performance-optimization-second-time/#%E8%BF%90%E8%A1%8C "运行")运行
...
### [](https://ming1016.github.io/2024/09/05/iOS-performance-optimization-second-time/#rules-xcodeproj-%E7%94%9F%E6%88%90-Xcode-%E5%B7%A5%E7%A8%8B "rules_xcodeproj 生成 Xcode 工程")rules\_xcodeproj 生成 Xcode 工程

[rules\_xcodeproj](https://github.com/MobileNativeFoundation/rules_xcodeproj) 是一个用于生成 Xcode 工程文件 (`.xcodeproj`) 的 Bazel 插件。它允许你在使用 Bazel 构建系统的同时，仍然能够使用 Xcode 进行开发和调试。它目前支持两种主要的构建模式：**BwB (Build with Bazel)** 和 \*\*BwX (Build with Xcode)\*\*。  
...
你需要替换 `<SHA256>` 和 `<version>` 为相应的值，可以从 [rules\_xcodeproj 的发布页面](https://github.com/buildbuddy-io/rules_xcodeproj/releases) 获取。
...
### [](https://ming1016.github.io/2024/09/05/iOS-performance-optimization-second-time/#Build-with-Proxy-%E6%A8%A1%E5%BC%8F "Build with Proxy 模式")Build with Proxy 模式
...
[](https://ming1016.github.io/2024/09/05/iOS-performance-optimization-second-time/#%E7%94%9F%E6%88%90-IPA-%E5%8C%85%E7%9A%84%E8%BF%87%E7%A8%8B "生成 IPA 包的过程")生成 IPA 包的过程
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
### [](https://ming1016.github.io/2024/09/05/iOS-performance-optimization-second-time/#%E4%BE%9D%E8%B5%96%E5%88%86%E6%9E%90 "依赖分析")依赖分析
...
### [](https://ming1016.github.io/2024/09/05/iOS-performance-optimization-second-time/#query%E6%8C%87%E4%BB%A4%E6%89%BE%E4%BE%9D%E8%B5%96%E5%85%B3%E7%B3%BB "query指令找依赖关系")query指令找依赖关系
...
### [](https://ming1016.github.io/2024/09/05/iOS-performance-optimization-second-time/#%E8%BF%9C%E7%A8%8B%E7%BC%93%E5%AD%98 "远程缓存")远程缓存
...
### [](https://ming1016.github.io/2024/09/05/iOS-performance-optimization-second-time/#%E8%BF%9C%E7%A8%8B%E6%89%A7%E8%A1%8C%E9%85%8D%E7%BD%AE "远程执行配置")远程执行配置
...
### [](https://ming1016.github.io/2024/09/05/iOS-performance-optimization-second-time/#%E8%87%AA%E5%AE%9A%E4%B9%89%E6%9E%84%E5%BB%BA%E8%A7%84%E5%88%99 "自定义构建规则")自定义构建规则
